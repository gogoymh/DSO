...
##  output a new cfg file
    ...
    prune_weights_path = os.path.join(save, "prune.pth")    
    torch.save(pruned_model.state_dict(), prune_weights_path)
...
#    torch.save(pruned_model.state_dict(), f"checkpoints/prune.weithgt")
